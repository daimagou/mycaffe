...
LIBRARIES += glog gflags protobuf leveldb snappy \
	lmdb boost_system hdf5_hl hdf5 m matio z \
...
LINKFLAGS += -L/usr/local/lib/ -pthread -fPIC $(COMMON_FLAGS) $(WARNINGS)
...
LDFLAGS += -L/usr/local/lib/ $(foreach librarydir,$(LIBRARY_DIRS),-L$(librarydir)) $(PKG_CONFIG) \
